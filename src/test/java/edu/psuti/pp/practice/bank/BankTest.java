...
//import static AccountNumberGenerator.getNext;
// Не работает статический импорт, не знаю, почему
public class BankTest {
    ...
    private static void testCreditAccount() {
        ...
        CreditAccount creditAccount_04 = new CreditAccount(
                ...
                25_000.0,
                150.0,
                AccountNumberGenerator.Currency.USD
        );
        CreditAccount creditAccount_05 = new CreditAccount(
                AccountNumberGenerator.getNext(),
                45_000.0,
                80.0,
                AccountNumberGenerator.Currency.RUB,
                5.5,
                100_000.0
        );
        ...
        creditAccount_01.setValut(AccountNumberGenerator.Currency.RUB);
        ...
        creditAccount_01.setValut(AccountNumberGenerator.Currency.JOY);
    ...
    private static void testNaturalClient() {
        ...
        C.add(new DebitAccount(
                ...
                25_000.0,
                20.0,
                AccountNumberGenerator.Currency.JOY
        ));
