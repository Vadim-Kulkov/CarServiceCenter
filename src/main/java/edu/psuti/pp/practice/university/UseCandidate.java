...
public class UseCandidate extends Candidate {
    private static final int DEFAULT_RESULT_USE = 0;

    private int resultPoints;

    public UseCandidate(int id,
                        int passportTally,
                        int passportNumber,
                        String firstName,
                        String middleName,
    ...
    public UseCandidate(int id,
        ...
        this(id, passportTally, passportNumber, firstName, middleName, lastName, directionList, DEFAULT_RESULT_USE);
    }
    ...
    public boolean equals(Object o) {
        ...
        Candidate candidate = (UseCandidate) o;
